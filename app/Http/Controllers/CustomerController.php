...
class CustomerController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return response()->json([
                'success' => true,
                'message' => __('customers.customer_created'),
                'customer' => $customer
            ]);
            ...
            return response()->json([
                'success' => false,
                'message' => __('customers.customer_creation_error')
            ], 500);
        }
    }
    ...
    public function update(Request $request, Customer $customer)
    {
        ...
        try {
            ...
            return response()->json([
                'success' => true,
                'message' => __('customers.customer_updated'),
                'customer' => $customer
            ]);
            ...
            return response()->json([
                'success' => false,
                'message' => __('customers.customer_update_error')
            ], 500);
        }
    }
    ...
    public function destroy(Customer $customer)
    {
        try {
            ...
            return response()->json([
                'success' => true,
                'message' => __('customers.customer_deleted')
            ]);
            ...
            return response()->json([
                'success' => false,
                'message' => __('customers.customer_deletion_error')
            ], 500);
        }
    }
}
